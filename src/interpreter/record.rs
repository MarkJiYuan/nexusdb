...
use crate::interpreter::utils::len_varint;
use crate::interpreter::utils::parse_varint;
...
) -> anyhow::Result<Record<BtreePayload<'a>, crate::interpreter::cursor::Error>> {
...
pub fn parse_record_header(payload: &BtreePayload) -> anyhow::Result<Vec<(SerialType, usize)>> {
    parse_record_header_payload::<BtreePayload, crate::interpreter::cursor::Error>(payload)
}
